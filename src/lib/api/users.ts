...
export async function createUser(name: string): Promise<{id: string} | undefined> {
...
export async function getUser(userId: string): Promise<{ id: string, name: string } | undefined> {
