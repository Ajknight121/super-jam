  ...
  return (
    ...
    <div class="card">
      ...
      <label class="field">
        ...
        <input class="wide-input" id = "meeting-name" type="text" placeholder="Insert the name of your meeting" />
      </label>
      ...
      <div class="field">
        ...
        <div class="time-row">
          <div class="time-group">
            <input class="time-input" id="start-time" type="time" />
          </div>

          <div class="to-text">TO</div>

          <div class="time-group">
            <input class="time-input" id="end-time" type="time" />
          </div>
        </div>
        <div class = "timezone-row">
          <span class="label-text">Time Zone:</span>

          <select id="timezones" name="timezones" class="span5 time-group">
            ...
            <option value="America/Chicago" selected = "selected">America/Chicago GMT-6:00</option>
      ...
      <div class="field">
        ...
        <div id="day-pills" role="group" aria-label="Days of week">
          <button type="button" class="pill" id = "sun-btn">Sun</button>
          <button type="button" class="pill" id = "mon-btn">Mon</button>
          <button type="button" class="pill" id = "tues-btn">Tues</button>
          <button type="button" class="pill" id = "weds-btn">Weds</button>
          <button type="button" class="pill" id = "thrs-btn">Thrs</button>
          <button type="button" class="pill" id = "fri-btn">Fri</button>
          <button type="button" class="pill" id = "sat-btn">Sat</button>
        </div>
      
      </div>
      <div id="calendar-area">
        <Calendar client:load month={_calendarMonth} year={_calendarYear} selectedDays={selectedDays} setSelectedDays={setSelectedDays} />
      </div>
    </div>
